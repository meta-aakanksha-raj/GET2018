...
public class UserFacade {
	...
	public Status registerUser(String firstName, String lastName, int age,
			String dob, String contact, String email, String password, String orgName) {
	...
	public List<UserFriendView> getUserFriendsData(String email) {
		...
		for (User user : listOfUsersFriedns) {
			String name = user.getFirstName() + " " + user.getLastName();
			UserFriendView userFriendView = new UserFriendView(name,
					user.getOrgName(), user.getAge(), user.getMobileNumber());
